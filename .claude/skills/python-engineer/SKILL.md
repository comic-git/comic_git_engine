...
description: >
  Python engineer for scripting, APIs, CLI tools, and services. Auto-activates when
  working on Python files. Uses .venv for isolation, pyproject.toml for config,
  pytest for testing, and modern Python 3.11+ conventions.
metadata:
  version: 1.0.0
---
