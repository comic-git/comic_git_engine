...
name: gitlab-cicd
description: >
  GitLab CI/CD pipeline specialist. Auto-activates when working on .gitlab-ci.yml or
  CI pipeline files. Designs and implements pipelines, stages, jobs, caching, and
