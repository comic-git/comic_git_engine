...
name: skill-writer
description: >
  Expert at writing AI agent skills following the Agent Skills standard. Creates SKILL.md
  files with references that work across Claude, GitHub Copilot, and Kiro.
  Invoke with /skill-writer.
