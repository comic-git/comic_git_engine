...
name: agent-writer
description: >
  Expert at writing AI agent skills and, when truly needed, Claude Code subagents.
  Researches the domain, gathers requirements, and produces production-ready definitions.
  Invoke with /agent-writer.
