...
name: react-engineer
description: >
  React frontend engineer for TypeScript projects. Auto-activates when working on
  React/TypeScript files. Builds components, hooks, and features using modern React
  patterns, detecting the project stack before writing code.
metadata:
  version: 1.0.0
---
