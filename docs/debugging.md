...
- Host repos are expected to contain `your_content/site_root/`. If the build fails complaining that the folder is missing, create it even if you do not have any custom root-level files yet.
