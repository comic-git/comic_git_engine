...
{% if use_images_in_navigation_bar %}
    ...
    {% else %}
        <a class="navigation-button first-button" href="{{ comic_base_dir }}/comic/{{ first_id }}/#{{ first_anchor }}"><img alt="First" src="{{ base_dir }}/your_content/images/navigation_icons/Icon_First.png"></a>
        <a class="navigation-button previous-button" href="{{ comic_base_dir }}/comic/{{ previous_id }}/#{{ previous_anchor }}"><img alt="Previous" src="{{ base_dir }}/your_content/images/navigation_icons/Icon_Previous.png"></a>
    {% endif %}
    ...
    {% else %}
        <a class="navigation-button next-button" href="{{ comic_base_dir }}/comic/{{ next_id }}/#{{ next_anchor }}"><img alt="Next" src="{{ base_dir }}/your_content/images/navigation_icons/Icon_Next.png"></a>
        <a class="navigation-button latest-button" href="{{ comic_base_dir }}/comic/{{ last_id }}/#{{ last_anchor }}"><img alt="Latest" src="{{ base_dir }}/your_content/images/navigation_icons/Icon_Latest.png"></a>
    {% endif %}
{% else %}
    {% if first_id == current_id %}
    ...
    {% else %}
        <a class="navigation-button first-button" href="{{ comic_base_dir }}/comic/{{ first_id }}/#{{ first_anchor }}">‹‹ First</a>
        <a class="navigation-button previous-button" href="{{ comic_base_dir }}/comic/{{ previous_id }}/#{{ previous_anchor }}">‹ Previous</a>
    {% endif %}
    {# The block below is the same as the one above, except it checks if you're on the last page. #}
    {% if last_id == current_id %}
    ...
    {% else %}
        <a class="navigation-button next-button" href="{{ comic_base_dir }}/comic/{{ next_id }}/#{{ next_anchor }}">Next ›</a>
        <a class="navigation-button latest-button" href="{{ comic_base_dir }}/comic/{{ last_id }}/#{{ last_anchor }}">Latest ››</a>
    {% endif %}
{% endif %}
</div>
